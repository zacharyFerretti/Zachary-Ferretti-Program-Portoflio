Hey this is just a simple program I wrote in CS 383 Fall 2018. The goal is to write a program 
...
The output goes line by line through the test data, and for each voter displays their predicted party, next to 
the probability the program calculates that the prediction is correct.